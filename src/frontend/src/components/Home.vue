<template>
    <div>
        ...
        >
            ...
            <span class="text-gray-500">Loading repositories...</span>
        </div>
        ...
        <div
            ...
            class="py-20 text-center bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700"
        >
            <div
        ...
        >
            <div
                ...
                :key="repo.id"
                class="group p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-md border border-gray-100 dark:border-gray-700 flex flex-col cursor-pointer transition-all duration-300"
                @click="goToRepo(repo)"
            >
                <div class="flex justify-between items-start mb-4">
                    ...
                    <a
                        ...
                        @click.stop
                        class="p-2 text-gray-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-all flex-shrink-0"
                ...
                <div
                    class="mt-auto pt-4 border-t border-gray-50 dark:border-gray-700/50"
                >
                    <div
                        class="flex items-center justify-between text-[11px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500"
                    >
