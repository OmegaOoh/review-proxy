    ...
    <div class="relative">
        ...
        <div class="relative mb-3">
            ...
            <input
                ...
                class="w-full pl-11 pr-4 py-3 bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-2xl text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all"
            />
        </div>

        <div
            v-if="userSearchQuery && (isSearching || searchResults.length > 0)"
            class="absolute z-[110] mt-1 w-full bg-white dark:bg-gray-800 shadow-2xl rounded-2xl border border-gray-200 dark:border-gray-700 max-h-48 overflow-auto p-2"
        >
            <div
                v-if="isSearching"
        ...
        <div class="flex flex-wrap gap-2">
            <span
                ...
                :key="auditor.id"
                class="inline-flex items-center gap-2 pl-2 pr-1.5 py-1.5 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs font-bold rounded-xl border border-blue-200 dark:border-blue-800/50"
            >
                <img
