...
const createIssue = async () => {
    if (!issueForm.value.title || !issueForm.value.repositoryId) {
        alert("Title and Repository ID are required");
        return;
    }
    ...
    try {
        ...
        const response = await fetch("/api/issues", {
            ...
            body: JSON.stringify({
                ...
                repositoryId: issueForm.value.repositoryId,
...
<template>
    <div
        class="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700"
    >
        ...
        >
            <div
                class="bg-white dark:bg-gray-800 rounded-lg max-w-lg w-full p-6"
            >
                <h3
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        >
                        <input
                            v-model="issueForm.repositoryId"
                            type="text"
                            class="w-full px-3 py-2 border rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
