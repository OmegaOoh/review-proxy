...
<template>
    <div
        class="mb-8 p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-3xl"
    >
        <h4
        ...
        >
            To allow ReviewProxy to manage issues, you must first install our
            GitHub App on your target repositories.
        </p>
        <a
